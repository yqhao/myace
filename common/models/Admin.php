...
//            $code = \Yii::$app->getUser()->getIdentity()->merchant_code;
//            if(!$code){
...
//                'dsn' => "mysql:host={$dsn['host']};port={$dsn['port']};dbname={$dsn['dbname']}",
//                'username' => $dsn['username'],
//                'password' => Helper::authcode($dsn['password'],'DECODE',$dsn['salt']),
//                'tablePrefix' => 'tb_',
//            ]);
//            $connection->open();
//            return $connection;
